...
class Adherent
{
     ...
     * @return Adherent
     */
    public function setIdFamille(\AllocMaria\BackOfficeBundle\Entity\FamilleAdherent $idFamille = null)
    {
     ...
     * Get idFamille
     *
     * @return \AllocMaria\BackOfficeBundle\Entity\FamilleAdherent
     */
     ...
     * Add idReferent
     *
     * @param \AllocMaria\BackOfficeBundle\Entity\ReferentAdherent $idReferent
     *
     * @return Adherent
     */
    public function addIdReferent(\AllocMaria\BackOfficeBundle\Entity\ReferentAdherent $idReferent)
    {
     ...
     * @param \AllocMaria\BackOfficeBundle\Entity\ReferentAdherent $idReferent
     */
    public function removeIdReferent(\AllocMaria\BackOfficeBundle\Entity\ReferentAdherent $idReferent)
    {
     ...
     * Add idActivite
     *
     * @param \AllocMaria\BackOfficeBundle\Entity\ActiviteSection $idActivite
     *
     * @return Adherent
     */
    public function addIdActivite(\AllocMaria\BackOfficeBundle\Entity\ActiviteSection $idActivite)
    {
     ...
     * @param \AllocMaria\BackOfficeBundle\Entity\ActiviteSection $idActivite
     */
    public function removeIdActivite(\AllocMaria\BackOfficeBundle\Entity\ActiviteSection $idActivite)
    {

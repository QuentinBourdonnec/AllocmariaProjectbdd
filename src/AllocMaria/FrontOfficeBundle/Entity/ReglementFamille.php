...
class ReglementFamille
{
     ...
     * Set idUser
     *
     * @param \AllocMaria\FrontOfficeBundle\Entity\UserBureauAssociation $idUser
     *
     * @return ReglementFamille
     */
    public function setIdUser(\AllocMaria\FrontOfficeBundle\Entity\UserBureauAssociation $idUser = null)
    {
        $this->idUser = $idUser;
     ...
     * Get idUser
     *
     * @return \AllocMaria\FrontOfficeBundle\Entity\UserBureauAssociation
     */
     ...
     * @return ReglementFamille
     */
    public function addIdFamille(\AllocMaria\FrontOfficeBundle\Entity\FamilleAdherent $idFamille)
    {
     ...
     * @param \AllocMaria\FrontOfficeBundle\Entity\FamilleAdherent $idFamille
     */
    public function removeIdFamille(\AllocMaria\FrontOfficeBundle\Entity\FamilleAdherent $idFamille)
    {
     ...
     * Add mode
     *
     * @param \AllocMaria\FrontOfficeBundle\Entity\ModeDeReglement $mode
     *
     * @return ReglementFamille
     */
    public function addMode(\AllocMaria\FrontOfficeBundle\Entity\ModeDeReglement $mode)
    {
        $this->mode[] = $mode;
     ...
     * @param \AllocMaria\FrontOfficeBundle\Entity\ModeDeReglement $mode
     */
    public function removeMode(\AllocMaria\FrontOfficeBundle\Entity\ModeDeReglement $mode)
    {
     ...
     * Add idVersement
     *
     * @param \AllocMaria\FrontOfficeBundle\Entity\VersementReglement $idVersement
     *
     * @return ReglementFamille
     */
    public function addIdVersement(\AllocMaria\FrontOfficeBundle\Entity\VersementReglement $idVersement)
    {
     ...
     * @param \AllocMaria\FrontOfficeBundle\Entity\VersementReglement $idVersement
     */
    public function removeIdVersement(\AllocMaria\FrontOfficeBundle\Entity\VersementReglement $idVersement)
    {
